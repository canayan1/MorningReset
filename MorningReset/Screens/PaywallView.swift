...
private struct PaywallCopy {
    ...
    static let onboarding = PaywallCopy(
        ...
        body: L10n.text(
            en: "Every tradition keeps one practice free forever. A single tier opens its traditions; All-Access opens everything — plus the soundscapes, your full history, and whatever we add next.",
            tr: "Her gelenekte bir pratik sonsuza dek ücretsiz. Tek paket kendi geleneklerini açar; All-Access ise her şeyi — artı sesler, tüm geçmişin ve sonra eklenecekler.",
            es: "Cada tradición mantiene una práctica gratis para siempre. Un nivel abre sus tradiciones; All-Access lo abre todo — más los sonidos, tu historial completo y lo que añadamos."
        ),
    ...
    static let contextual = PaywallCopy(
        ...
        body: L10n.text(
            en: "The free practice here is yours to keep. All-Access opens every routine in all ten traditions, and what lives inside each one.",
            tr: "Buradaki ücretsiz pratik senin. All-Access, on geleneğin tüm rutinlerini ve her birinin içinde yaşayanı açar.",
            es: "La práctica gratuita de aquí es tuya. All-Access abre todas las rutinas de las diez tradiciones, y lo que vive dentro de cada una."
        ),
        features: sharedFeatures,
        secondaryCTA: L10n.text(en: "Continue without Premium", tr: "Premium olmadan devam et", es: "Continuar sin Premium")
    )
    ...
    static let periodic = PaywallCopy(
        ...
        body: L10n.text(
            en: "The ten free practices stay free. If you want the full library, All-Access opens all 250.",
            tr: "On ücretsiz pratik ücretsiz kalır. Tüm kütüphaneyi istersen All-Access 250 rutini açar.",
            es: "Las diez prácticas gratuitas siguen siendo gratis. Si quieres la biblioteca completa, All-Access abre las 250."
        ),
        features: sharedFeatures,
